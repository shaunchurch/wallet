...
export function CreatePasswordScreen() {
  ...
  async function handleSubmit() {
    ...
    const resp = await sendWalletMessage({ type: 'wallet:create', password });
    if (resp.type === 'wallet:created') {
      setOnboardingData({ mnemonic: resp.mnemonic, address: resp.address });
      push('seed-phrase');
  ...
  return (
    <div className="flex flex-1 flex-col px-6 pt-12">
      <h1 className="text-xl font-bold">Create Password</h1>
